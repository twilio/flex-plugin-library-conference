...
export enum StringTemplates {
  ErrorConference = 'ConferencePluginErrorNotification',
  ExternalTransferFailedHangupNotification = 'ConferenceFailedHangupNotification',
}

const customStrings = {
  [StringTemplates.ErrorConference]: '{{error}}',
